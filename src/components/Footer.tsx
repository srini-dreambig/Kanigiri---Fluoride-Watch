    ...
    <footer className="bg-black/60 border-t border-white/5 py-16 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          <h4 className="text-xs font-bold uppercase tracking-widest text-brand-amber">Navigation</h4>
        ...
        <div className="space-y-4">
          <h4 className="text-xs font-bold uppercase tracking-widest text-brand-amber">Constituency</h4>
          <ul className="space-y-2 text-sm opacity-60">
            <li>P.C. Palli</li>
            <li>Kanigiri</li>
            <li>Pamur</li>
        ...
        <div className="space-y-4">
          <h4 className="text-xs font-bold uppercase tracking-widest text-brand-amber">Contact</h4>
          <ul className="space-y-3 text-sm opacity-60">
            ...
            <li className="flex items-center gap-3"><MapPin size={16} /> Kanigiri, Prakasam Dist, AP</li>
          </ul>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-white/5 flex flex-col md:row items-center justify-between gap-4">
        <p className="text-[10px] opacity-30 uppercase font-mono">
          © 2026 Kanigiri Fluoride Crisis Awareness. Non-Political Initiative.
        </p>
        <div className="flex gap-6 mt-4 md:mt-0">
          <a href="#" className="text-[10px] opacity-30 uppercase hover:opacity-100 transition-opacity">Privacy Policy</a>
          <a href="#" className="text-[10px] opacity-30 uppercase hover:opacity-100 transition-opacity">Terms of Use</a>
        </div>
      </div>
    </footer>
  );
